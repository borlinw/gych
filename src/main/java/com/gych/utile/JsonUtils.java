...
public class JsonUtils {
	 ...
	 *            不需要转换的属性数组
	 * @param datePattern
	 *            日期转换模式 w * @return JsonConfig
	 *            根据excludes和dataPattern生成的jsonConfig，用于write
	 */
	...
	public static void invokeWriteMethod(Object entity, Method writeMethod,
			Class propertyType, String propertyValue, String datePattern)
			throws Exception {
	 ...
	 *             可能抛出任何异常
	 */
	public static <T extends Object> T json2Bean(JSONObject jsonObject, T entity)
			throws Exception {
	...
	public static <T extends Object> List<T> json2List(String data,
			Class<T> clazz, String[] excludes, String datePattern)
			throws Exception {
		System.out.println("到达json2List2"+data);
		JSONArray jsonArray = JSONArray.fromObject(data);
		//JSONArray jsonArray =new JSONArray(data);
		System.out.println("到达json2List3"+jsonArray);
	...
	public static <T extends Object> List<T> json2List(String data,
			Class<T> clazz) throws Exception {
		System.out.println("到达json2List1"+data);
	...
	public static String listForJson(List<HashMap<String, Object>> list) throws IOException{
