		...
		$(function(){
			...
			/* $.ajax({
				...
				success:function(msg){
					...
					$('<li></li>').appendTo('.files').html(data.xmmc+data.wjlx+'                   <a href="/gych/sjjs/downWjFile.do?cgba.xmmc='+data.xmmc+'&cgba.wjlx='+data.wjlx+ '&cgba.url='+data.url+'"  style="text-decoration:none;"> 下载 </a> ');
				/* }
			});	 */
		});
